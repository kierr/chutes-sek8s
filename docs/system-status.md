...
| --- | --- |
| Service inventory | Enumerate the fixed allowlist of managed systemd units (admission controller, **system manager**, attestation service, k3s server, `nvidia-persistenced`, `nvidia-fabricmanager`, and `infiniband-mask`). |
